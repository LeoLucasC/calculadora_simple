...
if ($id_grupo == 0) { header("Location: galeria.php"); exit(); }
...
if (!$grupo) { header("Location: galeria.php"); exit(); }
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="page-header">
            <a href="galeria.php?ubicacion=<?= $grupo['id_ubicacion'] ?>" class="btn-back">
            ...
            <div class="header-info">
                ...
                <div class="breadcrumb">
                    ...
                    <a href="galeria.php?ubicacion=<?= $grupo['id_ubicacion'] ?>"><?= htmlspecialchars($grupo['ubicacion_nombre']) ?></a>
                    <i class="fas fa-chevron-right" style="font-size:0.75rem;"></i>
