    ...
    <div class="main-content" id="main-content">
        <div class="page-header">
            ...
            <div style="display: flex; gap: 10px;">
                <?php if ($ubicacion_id > 0): ?>
                <a href="viewer_galeria.php" class="btn-volver">
        ...
        <?php if ($ubicacion_id > 0): ?>
            <div class="gallery-grid" id="galleryGrid">
                ...
                <?php else: ?>
                    ...
                    <div class="gallery-card" data-name="<?= strtolower($g['grupo_nombre']); ?>" onclick="window.location.href='ver_grupo_viewer.php?id=<?= $g['id_grupo'] ?>&ubicacion=<?= $ubicacion_id ?>'">
        ...
        <?php else: ?>
            <div class="gallery-grid" id="galleryGrid">
                ...
                <?php else: ?>
                    ...
                    <!-- ✅ CAMBIO: onclick movido al gallery-card completo -->
                    <div class="gallery-card" data-name="<?= strtolower($g['ubicacion_nombre']); ?>" onclick="window.location.href='viewer_galeria.php?ubicacion=<?= $g['id_ubicacion'] ?>&tipo=<?= $tipo_filtro ?>'">
                        <div class="gallery-image">
                            <?php 
                            $archivo_portada = $g['portada'];
                            $extension = strtolower(pathinfo($archivo_portada, PATHINFO_EXTENSION));
                            ...
                            <div class="gallery-actions">
                                <!-- ✅ CAMBIO: event.stopPropagation() en botón editar -->
